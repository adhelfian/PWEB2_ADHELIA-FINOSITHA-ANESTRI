    ...
    <div class="container-scroller">
      <nav class="sidebar sidebar-offcanvas .bg-secondary" id="sidebar">
        <div class="text-center sidebar-brand-wrapper d-flex align-items-center">
          <a class="sidebar-brand brand-logo pl-4 pt-10 "><img src="assets/images/logominii.png" alt="logo" style="width:100%;max-width:300px" /></a>
          <a class="sidebar-brand brand-logo-mini pl-4 pt-3"><img src="assets/images/logomini.png" alt="logo" /></a>
        </div>
        <ul class="nav">
          <li class="nav-item nav-profile">
            <a href="#" class="nav-link">
              <!-- <div class="nav-profile-image">
                <img src="assets/images/faces/man.png" alt="profile" />
                <span class="login-status online"></span>
                change to offline or busy as needed
              </div>
              <div class="nav-profile-text d-flex flex-column pr-3">
                <span class="font-weight-medium mb-2">{{ auth()->user()->name }}</span>
                <span class="font-weight-normal">Teluk Penyu</span>
              </div> -->
            ...
            <ul class="navbar-nav navbar-nav-right ml-lg-auto">
              ...
              <li class="nav-item nav-profile dropdown border-0">
                <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-toggle="dropdown">
                  <img class="nav-profile-img mr-2" alt="" src="assets/images/faces/man.png" />
        ...
        <div class="main-panel">
          <div class="content-wrapper pb-0">
            <div class="page-header flex-wrap">
              <h3 class="mb-0"> Hai, Selamat Datang {{ auth()->user()->name }} ! <span class="pl-0 h6 pl-sm-2 text-muted d-inline-block">Silakan Isi Data Pengunjung.</span>
              </h3>
              <div class="d-flex">
            ...
            <div class="col-lg-12 stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Data Pengunjung Teluk Penyu</h4>
                    @if (auth()->user()->hak_akses=="admin")
                    <a href="/tambah-tiket" class="btn btn-sm btn-success" style="color:white;">Tambah</a>
                    @endif
                    </p>
                      ...
                      <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <!-- <a href="#" class="btn btn-sm btn-danger" style="color:white;">Hapus</a> -->
                                <form onsubmit="return confirm('Yakin akan menghapus data?')" class="d-inline" action="{{ url('dashboard/'.$r->id_jual) }}" method="post">
                                @csrf
                                @method('DELETE')
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © adheliafinosithaanestri</span>
